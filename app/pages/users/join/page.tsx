  ...
  return (
    <Container maxWidth="sm">
      ...
      <Box component="form" noValidate autoComplete="off">
        ...
        />
        <TextField fullWidth label="Name" margin="normal" onChange={handleName} />
        <TextField fullWidth label="Phone" margin="normal" onChange={handlePhone} />
        ...
        <Box mt={2}>
          ...
          {' '}
          <Button variant="contained" color="primary" onClick={handleSignup} type="submit">
            Sign Up
          </Button>
        </Box>
      </Box>
